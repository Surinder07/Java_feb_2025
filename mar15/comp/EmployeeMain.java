...
public class EmployeeMain {
    public static void main(String[] args) {
        ...
        Employee employee1 = new Employee(101, name, "yadav@gmail.com",
                                new Address("225 King street", "Toronto", "Ontario", "Canada", "A1B 2S4"),
                                 200000.00);



        Employee employee2 = new Employee(102, name, "niraj@gmail.com",address2, 190000.10);
        Employee employee3 = new Employee(103, name, "niraj@gmail.com",address3, 190000.10);
        Employee employee4 = new Employee(104, name, "niraj@gmail.com",address4, 190000.10);
        Employee employee5 = new Employee(105, name, "niraj@gmail.com",address5, 190000.10);
